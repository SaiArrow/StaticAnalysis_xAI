...
experiments = pd.read_csv('attn_experiments_h.csv')
        ...
        for seed in [42, 1975, 5827, 7421, 9876]:
            ...
            for i, (train_index, test_index) in enumerate(sss.split(raw_text, label)):
                ...
                training_args = TrainingArguments(
                    output_dir = model_name+'_kl_sequence_classification_'+str(learning_rate)+str(i),
                ...
                with open('attn_experiments_h.csv', 'a') as f:
